...
// Inter Position Post Type
function intern_post_type() {

	$labels = array(
		'name'                  => 'Interns',
		'singular_name'         => 'Intern',
		'menu_name'             => 'Intern',
		'name_admin_bar'        => 'Intern',
		...
		'update_item'           => 'Update Intern',
		'view_item'             => 'View Intern',
		'view_items'            => 'View Intern',
		'search_items'          => 'Search Intern',
		'not_found'             => 'Not found',
		'not_found_in_trash'    => 'Not found in Trash',
		'featured_image'        => 'Featured Image',
		'set_featured_image'    => 'Set featured image',
		'remove_featured_image' => 'Remove featured image',
		'use_featured_image'    => 'Use as featured image',
		'insert_into_item'      => 'Insert into Intern',
		'uploaded_to_this_item' => 'Uploaded to this Intern',
		'items_list'            => 'Intern list',
		'items_list_navigation' => 'Intern list navigation',
		'filter_items_list'     => 'Filter Intern list',
	);
	$args = array(
		'label'                 => 'Intern',
		'description'           => 'Intern Positions',
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'revisions', ),
		'taxonomies'            => array( 'intern' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
	...
	register_post_type( 'intern', $args );

}
add_action( 'init', 'intern_post_type', 0 );